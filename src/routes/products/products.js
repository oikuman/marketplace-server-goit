const products = [
  {
    ...
    description:
      "Пицца пепперони - очень популярный вид пиццы как в Европе, так и в Америке. Она получила свое название благодаря основному ингредиенту солями пепперони, который и отличает ее от всех остальных видов пицц. Он имеет острый вкус и при запекании покрывается хрустящей жирной корочкой.",
    image:
      "https://proxy10.online.ua/retsepty/r2-ed38266948/big56aa51d079bb1.jpg",
    price: "100",
    currency: "UAN",
    creatorId: 1,
    created: "21-08-2018",
  ...
  },
  {
    ...
    description:
      "Пожалуй, самая популярная в мире, даже меню любой пиццерии начинается, как правило, именно с неё. Состав этой пиццы необычайно прост, её основные ингредиенты: сыр моцарелла, спелые помидоры и листья свежего базилика, которые придают ей неповторимый вкус и аромат.",
    image:
      "https://images.pizza33.ua/products/product/ushRHz87eowETDHfZfQ3A1QNrpeoogmm.jpg",
    price: "80",
    currency: "UAN",
    creatorId: 1,
    created: "21-08-2018",
  ...
  },
  {
    ...
    image: "https://i.ibb.co/G0qHZVL/emfu-10730026-7040350-orig.jpg",
    price: 150,
    currency: "UAN",
    creatorId: 1,
    created: "21-08-2018",
